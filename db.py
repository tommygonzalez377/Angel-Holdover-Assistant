...
def _do_seed_aliases():
    ...
    SEED_ALIASES = [
        ...
        ('rave university city 6', 'philadelphia', 'Cinemark University City Philadelphia 6', 'Cinemark'),
        ('cinemark (moosic)', 'moosic', 'Cinemark Moosic 20 + XD', 'Cinemark'),
        ('cinemark (moosic)', '', 'Cinemark Moosic 20 + XD', 'Cinemark'),
        ('cinemark raleigh grande', 'raleigh', 'Cinemark Raleigh Grand 16', 'Cinemark'),
